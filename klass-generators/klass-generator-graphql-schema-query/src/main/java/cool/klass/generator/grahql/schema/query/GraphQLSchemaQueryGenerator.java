...
public class GraphQLSchemaQueryGenerator extends AbstractPerPackageGenerator {
	...
	protected String getPackageSourceCode(@Nonnull String fullyQualifiedPackage) {
		...
		String byOperationSourceCode = classes.collect(this::getByOperationSourceCode).makeString("");

		String byFinderSourceCode = classes.collect(this::getByFinderSourceCode).makeString("");
	...
	private String getByKeySourceCode(Classifier classifier) {
		...
		String parameters = classifier.getKeyProperties().collect(this::getParameterSourceCode).makeString();
