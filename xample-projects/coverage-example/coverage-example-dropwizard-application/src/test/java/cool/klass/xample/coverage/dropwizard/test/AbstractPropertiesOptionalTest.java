...
public abstract class AbstractPropertiesOptionalTest extends AbstractCoverageTest {

	@Override
	protected String getGoldenFilePrefix() {
		return "PropertiesOptionalTest";
	}
	...
	void putFirst() {
		...
		String jsonName = "PropertiesOptionalTest.putFirst.json5";
		String json = FileSlurper.slurp(jsonName, AbstractPropertiesOptionalTest.class);
