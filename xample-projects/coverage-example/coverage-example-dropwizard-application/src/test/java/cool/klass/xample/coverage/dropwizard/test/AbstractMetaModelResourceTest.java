...
public abstract class AbstractMetaModelResourceTest extends AbstractCoverageTest {

	@Override
	protected String getGoldenFilePrefix() {
		return "MetaModelResourceTest";
	}
	...
	void getEnumerationByName() {
		...
		Response response = client
			...
			.resolveTemplate("port", this.appExtension.getLocalPort())
			.resolveTemplate("name", "Multiplicity")
			.request(MediaType.APPLICATION_JSON_TYPE)
			.get();
	...
	void getAssociationByName() {
		...
		Response response = client
			...
			.resolveTemplate("port", this.appExtension.getLocalPort())
			.resolveTemplate("name", "EveryTypeKeyPropertyHasEveryTypeForeignKeyProperty")
			.request(MediaType.APPLICATION_JSON_TYPE)
			.get();
	...
	void getInterfaceByName() {
		...
		Response response = client
			...
			.resolveTemplate("port", this.appExtension.getLocalPort())
			.resolveTemplate("name", "NamedElement")
			.request(MediaType.APPLICATION_JSON_TYPE)
			.get();
	...
	void getServiceGroupByName() {
		...
		Response response = client
			...
			.resolveTemplate("port", this.appExtension.getLocalPort())
			.resolveTemplate("name", "UserResource")
			.request(MediaType.APPLICATION_JSON_TYPE)
			.get();
