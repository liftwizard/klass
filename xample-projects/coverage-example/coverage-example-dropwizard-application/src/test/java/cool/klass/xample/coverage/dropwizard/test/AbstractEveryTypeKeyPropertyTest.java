...
public abstract class AbstractEveryTypeKeyPropertyTest extends AbstractCoverageTest {

	@Override
	protected String getGoldenFilePrefix() {
		return "EveryTypeKeyPropertyTest";
	}
	...
	void postSingle() {
		...
		String json = FileSlurper.slurp("EveryTypeKeyPropertyTest.postSingle.json5", AbstractEveryTypeKeyPropertyTest.class);
	...
	void postSingleWithProjection() {
		...
		String json = FileSlurper.slurp(
			"EveryTypeKeyPropertyTest.postSingleWithProjection.json5",
			AbstractEveryTypeKeyPropertyTest.class
		);
	...
	void postMultiple() {
		...
		String json = FileSlurper.slurp("EveryTypeKeyPropertyTest.postMultiple.json5", AbstractEveryTypeKeyPropertyTest.class);
	...
	void postMultipleWithProjection() {
		...
		String json = FileSlurper.slurp(
			"EveryTypeKeyPropertyTest.postMultipleWithProjection.json5",
			AbstractEveryTypeKeyPropertyTest.class
		);
	...
	void put() {
		...
		{
			String jsonName = "EveryTypeKeyPropertyTest.put.json5";
			String json = FileSlurper.slurp(jsonName, AbstractEveryTypeKeyPropertyTest.class);
