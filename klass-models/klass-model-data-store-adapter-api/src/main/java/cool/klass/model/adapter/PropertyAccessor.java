...
/**
 * Base interface for all property accessors. A unified accessor combines
 * getter and setter functionality with a reference to the corresponding
 * domain model Property.
 *
 * <p>This design is similar to Reladomo's Attribute class, but abstracted
...
public interface PropertyAccessor<T, V> {
	...
	/**
	 * Returns the Property from the domain model that this accessor corresponds to.
