...
/**
 * Accessor for to-many association ends (multiplicity 0..* or 1..*).
 ...
 */
public interface ToManyAssociationEndAccessor<T, E> extends AssociationEndAccessor<T, ImmutableList<E>> {}
