...
public class TypeMemberReferencePath extends TypeMemberReferencePathAbstract {
    ...
    public String toString() {
        ...
        return memberReferencePath.getKlass().getName() + associationEndsString + memberReferencePath.getPropertyName();
    }
}
