...
/**
 * A factory for creating a Domain Model using the Klass compiler.
 * Configuration requires a colorScheme to be specified, validated using @ValidationMethod.
 * Valid color schemes include "dark", "light", "dark-cube", and "dark-rgb".
 */
        ...
        implements DomainModelFactory
{
    ...
    public DomainModelWithSourceCode createDomainModel(ObjectMapper objectMapper)
    {
        ...
        // Since validation passed, we know colorScheme is valid
        LOGGER.info("Using color scheme: {}", this.colorScheme);
    ...
    /**
     * Validates that the specified color scheme exists and can be loaded from the classpath.
     * This ensures that the configuration has a valid color scheme before the application starts.
     *
     * @return true if the color scheme is valid and can be loaded
     */
