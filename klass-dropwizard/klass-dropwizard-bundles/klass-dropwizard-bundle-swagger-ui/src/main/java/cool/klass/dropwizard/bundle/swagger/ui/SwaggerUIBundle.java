 ...
 * endpoint, which is served by SwaggerSpecResource in klass-service-swagger.
 * </p>
 */
...
public class SwaggerUIBundle implements PrioritizedBundle {
	...
	public void initializeWithMdc(@Nonnull Bootstrap<?> bootstrap) {
		...
		bootstrap.addBundle(new AssetsBundle("/swagger-ui-custom", "/swagger", "index.html", "swagger"));
	}
