...
/**
 * JAX-RS resource that serves the Swagger/OpenAPI specification file from the classpath.
 * <p>
 * The swagger.json file is generated by the klass-generator-swagger-plugin during build
 * and packaged as a resource in the application classpath.
 * </p>
 */
@Path("/")
public class SwaggerSpecResource {
	...
	/**
	 * Serves the swagger.json specification.
	 *
