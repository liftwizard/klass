...
public final class AnsiSyntaxHighlighter {
    ...
    public static Ansi highlightSourceCode(
        ...
        for (Token token : tokenStream.getTokens()) {
            TokenCategory category = getTokenCategory(
                token,
            ...
            String formattedText = formatTokenText(token, category);
    ...
    private static AnsiColorStyle convertCategoryToStyle(TokenCategory category, AnsiColorScheme colorScheme) {
        StyleState styleState = StyleExtractor.extractStyleState(category, colorScheme);
    ...
    private static String formatTokenText(Token token, TokenCategory category) {
