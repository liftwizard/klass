...
public class FunctionalSyntaxHighlighter {
    ...
    private StyleState currentStyle = StyleState.EMPTY;
    ...
    public void resetStyle() {
        this.currentStyle = StyleState.EMPTY;
    }
    ...
    public Ansi highlightTokens(@Nonnull Iterable<Token> tokens) {
        ...
        for (Token token : tokens) {
            ...
            if (tokenCategory != null) {
                ...
                this.currentStyle = StyleTransition.transition(this.currentStyle, targetStyle, ansi);

                if (tokenCategory == TokenCategory.WHITESPACE) {
                    ansi.a(token.getText().replace(' ', '·'));
                } else if (tokenCategory == TokenCategory.NEWLINE) {
                    ansi.a("¶");
                    ansi.a("RESET");
                    this.currentStyle = StyleState.EMPTY;
                    this.colorScheme.background(ansi);
        ...
        // Always ensure we have a reset, even if no tokens were processed
        ansi.a("RESET");
